...
MORAL_DIMENSIONS = [
    ...
    "加强安全防范    为人师表，以身作则，举止文明，作风正派，自重自爱；不得与学生发生任何不正当关系，严禁任何形式的猥亵、性骚扰行为。", 
    "坚持言行雅正    严谨治学，力戒浮躁，潜心问道，勇于探索，坚守学术良知，反对学术不端；不得抄袭剽窃、篡改侵吞他人学术成果，或滥用学术资源和学术影响。", 
    "秉持公平诚信    坚持原则，处事公道，光明磊落，为人正直；不得在招生、考试、推优、保研、就业及绩效考核、岗位聘用、职称评聘、评优评奖等工作中徇私舞弊、弄虚作假。", 
    "坚守廉洁自律    严于律己，清廉从教；不得索要、收受学生及家长财物，不得参加由学生及家长付费的宴请、旅游、娱乐休闲等活动，或利用家长资源谋取私利。", 
    "规范从教行为    履行社会责任，贡献聪明才智，树立正确义利观；不得假公济私，擅自利用学校名义或校名、校徽、专利、场所等资源谋取个人利益。"
]
TEACHING_DIMENSIONS = ["教学态度  教学态度端正，教育教学工作认真负责。",
                       "教学能力  具有良好的教学设计能力、教学执行能力、教学评价能力和教学研究能力。备课、上课扎实认真，作业批改及时规范，班级管理严谨细实，学生辅导效果良好。", 
                       "教学效果  所带班级纪律严明，学生品德良好，成绩优异，业绩突出。"]
